...
/**
 * ExcelUploadCard - drag & drop upload card for the class Excel file.
  ...
  return (
    <div className="method-card addclass-upload-card">
      <div className="method-card-head">
        ...
        <p>Add multiple classes at once using a spreadsheet.</p>
      </div>
      ...
      <p className="class-hint">
        <ExcelExample
          headings={['Class Name', 'Short Code', 'Section']}
          rows={[
            ['Computer Science Engineering', 'CSE', 'A'],
            ['Electronics & Communication', 'ECE', 'B'],
          ]}
