...
/**
 * ExcelUploadCard - drag & drop upload card for the faculty Excel file.
 ...
 */
export default function ExcelUploadCard({ file, onFileChange, busy, onValidate }) {
  ...
  return (
    <div className="method-card addclass-upload-card">
      <div className="method-card-head">
        ...
        <p>Assign multiple faculty members at once using a spreadsheet.</p>
      </div>
      ...
      <p className="class-hint">
        <ExcelExample
          headings={['Faculty Name', 'Subject Name', 'Classes / Branch']}
          rows={[
            ['Dr. Ramesh', 'Data Structures', 'CSE-1, CSM-2'],
            ['Prof. Kavya', 'Engineering Mathematics', 'ECE-2'],
          ]}
