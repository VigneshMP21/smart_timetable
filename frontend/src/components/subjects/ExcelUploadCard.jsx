...
/**
 * ExcelUploadCard - drag & drop upload card for the subject Excel file.
  ...
  return (
    <div className="method-card addclass-upload-card">
      <div className="method-card-head">
        ...
        <p>Add multiple subjects at once using a spreadsheet.</p>
      </div>
      ...
      <p className="class-hint">
        <ExcelExample
          headings={['Subject Code', 'Subject Name', 'Branch/Class']}
          rows={[
            ['CS201', 'Data Structures', 'CSE, ECE'],
            ['MA101', 'Engineering Mathematics', 'CSE'],
          ]}
